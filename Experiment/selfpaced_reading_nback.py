...
sound_stim = sound.Sound(value = frequency, secs = duration, sampleRate = 44100, bits = 16)
sound_stim.setSound(sinewave = True)
sound_stim.setVolume(amplitude)
# play sound
sound_stim.play()
