...
if not skip_questions_paced:
    ...
    question_time, onset_time_rel2trigger, chosen_ans, is_correct, button_pressed = display_question_and_get_response(
        question, answers, Q1_correct)
