...
text_01_Q1_ans = ["1) sie wurden nicht mehr befischt, weshalb ihr Bestand innerhalb einer Saison quasi explodierte",
                  "2) vor Chile gab es im Sommer zuvor ein großes Haisterben, weshalb sie kaum noch natürliche Fressfeinde hatten",
                  "3) sie folgten kleinen Beutefischen vor die Küste",
                  "4) sie wurden von Meeresbiologen vor der Küste Perus ausgewildert und migrierten dann nach Süden"]
text_01_Q1_corr = "c"
...
text_02_Q1_ans = ["1) seiner Frau Mary Welsh Hemingway", "2) seiner Lieblingsbar “Sloppy Joe’s” in Key West, Florida",
                  "3) einer Wallfahrtskirche zu Ehren der Schutzpatronin von Kuba", "4) dem Fischer Gregorio Fuentes"]
text_02_Q1_corr = "c"
...
text_03_Q2_ans = ["1) einen verschüchterten Papagei", "2) einen lethargischen Kater", "3) eine depressive Schildkröte",
                  "4) einen taubstummen Kanarienvogel"]
text_03_Q2_corr = "a"
...
text_04_Q1_ans = ["1) er wollte einen Alkohol-Entzug machen", "2) er wollte sich von einer Lungenentzündung erholen",
                  "3) er wollte abnehmen", "4) er wollte zunehmen"]
text_04_Q1_corr = "d"
...
text_05_Q2_ans = ["1) Miguel Vences hat jede Chamäleon-Art nach je einem Forscher aus seinem Team benannt.",
                  "2) Ihre Namen beinhalten alle das lateinische Wort \"minima\" für \"klein\".",
                  "3) Ihre Namen beinhalten alle ein negativ konnotiertes Adjektiv wie \"desperata\" oder \"tristis\".",
                  "4) Alle Chamäleon-Arten wurden nach berühmten Tierschutz-Aktivist*innen benannt."]
text_05_Q2_corr = "c"

text_05_Q3 = "Wo verstecken sich die Chamäleons tagsüber?"
text_05_Q3_ans = ["1) unter Mangroven-Wurzeln", "2) unter Laub auf dem Boden", "3) unter Steinen und in Felsnischen",
...
text_07_Q3_ans = ["1) durch Massaker im Rahmen der Kolonialisierung Südostasiens", "2) durch eine Hungersnot",
...
text_10_Q2_ans = ["1) die Polizei schaut weg", "2) Metal-Bands dürfen nicht mehr auftreten",
                  "3) Metal-Fans geben sich nicht mehr als solche zu erkennen",
                  "4) der Staat fürchtet Demonstrationen "]
text_10_Q2_corr = "b"
