...
expInfo = {
    ...
    'session': '001',
    'testing_mode': 'yes',
    'RT_per_rectangle_oneback_single': '20',
    'RT_per_rectangle_twoback_single': '20',
    'RT_per_letter_baseline': '20',
    'RT_per_letter_oneback_dual': '20',
    'RT_per_letter_twoback_dual': '20',
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/data/tu_martin_cloud/EXNAT/EXNAT_fMRI/Psychopy_experiment/EXNAT_3_fMRI/EXNAT_3_fMRI.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisLoop_dual_task_block in loop_dual_task_blocks:
        ...
        # Run 'Begin Routine' code from dual_task_alt
        def setup_instructions_and_stimuli(block_config, curr_instr, curr_instr_pic):
            ...
            instr_pic.draw()
            win.flip()
            core.wait(3)  # wait for 3s before starting
        ...
        def process_block(block_config, curr_text, run_nr, block_nr_run, curr_block, curr_targets, curr_colours, curr_instr, curr_instr_pic):
            """
            Process each block based on its configuration.
            """
            setup_instructions_and_stimuli(block_config, curr_instr, curr_instr_pic)
        ...
        if exp_block_counter == 6:
            ...
            if block_config:
                ...
                # show main block questions
                skip_questions_paced = False
                process_block(block_config, curr_text, run_nr, block_nr_run, curr_block, curr_targets, curr_colours, curr_instr, curr_instr_pic)
                # continueRoutine = False
            else:
            ...
            if block_config:
                ...
                print("Error: Block configuration not found.")
        # Run 'Begin Routine' code from questions_dual_task_alt
        ##########################################################
        #              Text Comprehension Questions              #
        ##########################################################
