...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/sandramartin/ownCloud/EXNAT/EXNAT_fMRI/Psychopy_experiment/EXNAT_3_training/EXNAT_3_training.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    blocks_textlen = [55, 91, 20, 91,
                      20, 20, 90, 91,
                      20, 20, 90, 91,
                      58, 91, 91, 90, 91, 90, 91,
                      100]
